...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('CREATE TABLE backup_tipo_vaga AS SELECT * FROM tipo_vaga');
        ...
        DB::statement('ALTER TABLE tipo_vaga CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci');
        ...
        foreach ($columns as $column) {
            DB::statement("UPDATE tipo_vaga SET {$column} = CONVERT(CAST(CONVERT({$column} USING latin1) AS BINARY) USING utf8mb4)");
            DB::statement("UPDATE tipo_vaga SET {$column} = CONVERT(CAST(CONVERT({$column} USING latin1) AS BINARY) USING utf8mb4)");
        }

        Schema::table('tipo_vaga', function (Blueprint $table) {
            $table->timestamps();
        });
    }
    ...
    public function down(): void
    {
        ...
        DB::statement('RENAME TABLE backup_tipo_vaga TO tipo_vaga');
    }
};

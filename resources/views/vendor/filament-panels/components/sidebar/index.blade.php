...
<aside x-data="{}"
    ...
    {{-- custom height: changed h-screen to h-full max-h-screen --}}
    {{ $attributes->class([
        'fi-sidebar fixed inset-y-0 start-0 z-30 flex flex-col h-full max-h-screen content-start bg-white transition-all dark:bg-gray-900 lg:z-0 lg:bg-transparent lg:shadow-none lg:ring-0 lg:transition-none dark:lg:bg-transparent',
    ...
    <nav class="fi-sidebar-nav grow flex flex-col gap-y-7 overflow-y-auto overflow-x-hidden px-6 py-8"

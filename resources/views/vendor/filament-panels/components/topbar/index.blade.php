...
<div
    ...
    <nav
        ...
        {{-- insert brand name for mobile only, panels app and candidato --}}
        @php
            $panelId = filament()->getCurrentPanel()->getId();
        @endphp

        @if (in_array($panelId, ['app', 'candidato']))
            <a href="/" class="block lg:hidden font-extrabold text-white truncate">
                Processo Seletivo
            </a>
        @endif
    ...
    {{-- insert media query to customize global search width, mobile only --}}
    <style>
